...
interface AccountEditPageIMIProps {
  onCancel?: () => void;
...
export function AccountEditPageIMI({
  onCancel,
  ...
  const currentLabels = labels[vendorType];
              ...
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger className="h-12 border border-gray-200 rounded-xl">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>

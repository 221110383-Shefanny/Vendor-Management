...
export function LoginScreenIMI({ onLogin }: LoginScreenProps) {
  ...
  const labels = {
    local: {
      ...
      footer: "Sistem Manajemen Invoice Indo Mulia Indah",
    ...
    overseas: {
      ...
      needHelp: "Need Help?",
      footer: "Indo Mulia Indah Invoice Management System",
